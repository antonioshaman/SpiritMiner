...
async def cb_about(callback: CallbackQuery) -> None:
    text = (
        ...
        "\U0001f50d Проверить монету — анализ + пулы\n"
        ...
        "\U0001f4ca Голосование — sentiment index\n"
        "\U0001f3c5 Spirit Rank — рейтинг + Spirit Points\n"
        "\U0001f91d Партнёры — пулы и биржи\n"
        "\U0001f4ca Spirit Index — пульс рынка\n"
